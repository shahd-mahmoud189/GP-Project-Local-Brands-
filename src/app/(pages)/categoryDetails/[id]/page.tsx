        ...
        <div className="col-span-1 space-y-4 mb-8">
          ...
          <div className="flex items-center">
            <input
              ...
              id="low"
              value="low"
              className="accent-[#864227] size-4 mr-2 border-red-600"
            />
            <label htmlFor="low" className="text-slate-700 font-light">
              Under 200 EGB
            </label>
          </div>
          <div className="flex items-center">
            ...
            />
            <label htmlFor="medium" className="text-slate-700 font-light">
              500 EGP - 1000 EGP
            </label>
          </div>
          <div className="flex items-center">
            <input
              ...
              className="accent-[#864227] size-4 mr-2"
            />
            <label htmlFor="high" className="text-slate-700 font-light">
              +1000 EGP
            </label>
          </div>
          ...
          <div className="flex items-center">
            <input
              ...
              className="accent-[#864227] size-4 mr-2 border-red-600"
            />
            <label htmlFor="brand1" className="text-slate-700 font-light">
              Terra & Co
            </label>
          </div>
          <div className="flex items-center">
            <input
              ...
              className="accent-[#864227] size-4 mr-2"
            />
            <label htmlFor="brand2" className="text-slate-700 font-light">
              Oak & Embers
            </label>
          </div>
          <div className="flex items-center">
            <input
              ...
              className="accent-[#864227] size-4 mr-2"
            />
            <label htmlFor="brand3" className="text-slate-700 font-light">
              The Modern Weaver
            </label>
          </div>
        </div>
