    ...
    <div className="p-8">
      ...
      <div className="grid md:grid-cols-4 gap-10 mb-12">
        <div className="md:col-span-1 border border-[#EEEEEE] rounded-2xl p-4">
          ...
          <h5 className="text-[#864227] text-3xl font-bold mt-2">125,000</h5>
        ...
        <div className="md:col-span-1 border border-[#EEEEEE] rounded-2xl p-4">
          ...
          <h5 className="text-[#864227] text-3xl font-bold mt-2">8</h5>     
        </div>
        <div className="md:col-span-1 border border-[#EEEEEE] rounded-2xl p-4">
          <p className="uppercase text-[#6B5B54] tracking-wider text-sm font-bold">
           Products Pending
          </p>
          <h5 className="text-[#864227] text-3xl font-bold mt-2">22</h5>
        </div>
        <div className="md:col-span-1 border border-[#EEEEEE] rounded-2xl p-4">
          <p className="uppercase text-[#6B5B54] tracking-wider text-sm font-bold">
          Total Users
          </p>
          <h5 className="text-[#864227] text-3xl font-bold mt-2">1,450</h5>
        </div>
      </div>
    </div>
  );
