...
export async function getAllBrands() {
  const {data} = await api.get('https://graduationprojectclean-production.up.railway.app/api/Brands'); 
  return data;
}

export async function getSingleBrand(id:string):Promise<BrandDetailsResponse>{
  const {data} = await api.get(`https://graduationprojectclean-production.up.railway.app/api/Brands/${id}`); 
  return data;
}

export async function getMyBrands():Promise<BrandList>{
  const {data} = await api.get(`https://graduationprojectclean-production.up.railway.app/api/Brands/my-brands`); 
  return data;
}
